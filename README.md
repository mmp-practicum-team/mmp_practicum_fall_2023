# Курс "Практикум на ЭВМ 2023/2024" для бакалавров 3 курса кафедры ММП ВМК МГУ, осенний семестр

Этот репозиторий содержит материалы к курсу "Практикум на ЭВМ", читаемому бакалаврам 3 курса кафедры ММП факультета ВМК МГУ в осеннем семестре 2023 года.
...
| :---------: | :---: | --------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| 07 сентября |  01   | <ul><li>Введение в Python</li></ul>                                                                 | [Введение в Python](Seminars/01-intro/intro.ipynb)                                     | Контест 1: [Введение в язык Python](https://contest.yandex.ru/contest/51815/enter)                                          |
| 14 сентября |  02   | <ul><li>Организация кода в Python: функции, модули, классы</li><li>Итераторы и генераторы</li></ul> | [Функции, модули, классы. Итераторы и генераторы](Seminars/02-code-org/code-org.ipynb) | Контест 2: [Классы, генераторы](https://contest.yandex.ru/contest/52481/enter)                                              |
| 21 сентября |  03   | <ul><li>Библиотека numpy и матрично-векторные вычисления</li></ul>                                  | [Введение в numpy](Seminars/03-numpy/numpy.ipynb)                                      | Контест 3: [Векторизация вычислений с помощью библиотеки Numpy](https://contest.yandex.ru/contest/52514/enter/)             |
| 28 сентября |  04   | <ul><li>Введение в обработку изображений</li><li>KNN</li></ul>                                      | [Обработка изображений, KNN](Seminars/04-image-processing-and-KNN)                     | Задание 1: [Метрические алгоритмы классификации](Tasks/Task-01/task_01.pdf)                                                 |
| 05 октября  |  05   | <ul><li>Подготовка отчётов</li><li>Система TeX</li></ul>                                            | [Подготовка отчётов](Seminars/05-reports-tex)                                          | —                                                                                                                           |
| 12 октября  |  06   | <ul><li>Основы ООП</li></ul>                                                                        | [Основы ООП](Seminars/06-classes/classes.ipynb)                                        | —                                                                                                                           |
| 19 октября  |  07   | <ul><li>Основы ООП</li></ul>                                                                        | [Проектирование кода](Seminars/07-oop/oop.ipynb)                                       | Контест 4: [Декораторы, итераторы, классы](https://contest.yandex.ru/contest/52516/enter)                                   |
| 26 октября  |  08   | <ul><li>Введение в обработку текстов</li></ul>                                                      | [Введение в обработку текстов](Seminars/08-text-processing-and-logreg/seminar.pdf)     | Задание 2: [Градиентные методы обучения линейных моделей](Tasks/Task-02/task_02.pdf)                                        |
|  02 ноября  |  09   | <ul><li>Базовые инструменты разработчика. VM, SSH, GIT</li></ul>                                    | [Базовые инструменты разработчика](Seminars/09-dev-tools/dev_tools.ipynb)              | –                                                                                                                           |
|  09 ноября  |  10   | <ul><li>Виртуальные окружения и контейнеры</li></ul>                                                | [Виртуальные окружения и контейнеры](Seminars/10-environments/environments.ipynb)      | —                                                                                                                           |
|  16 ноября  |  11   | <ul><li>Основы веб-разработки (введение)</li></ul>                                                  | [Введение в основы веб-разработки](Seminars/11-webdev-intro/11-web-intro.ipynb)        | —                                                                                                                           |
|  23 ноября  |  12   | <ul><li>Flask</li></ul>                                                                             | [Пример Flask приложения](Seminars/12-flask)                                           | Задание 3: [Ансамбли алгоритмов. Веб-сервер. Композиции алгоритмов для решения задачи регрессии](Tasks/Task-03/task_03.pdf) |
|  30 ноября  |  13   | <ul><li>Серверная разработка на Python (продолжение)</li></ul>                                      | [Серверная веб-разработка](Seminars/13-web-servers)                                    | —                                                                                                                           |
| 07 декабря  |  14   | <ul><li>Ctypes</li></ul>                                                                            | [Ctypes](Seminars/14-ctypes)                                                           | ＼(٥⁀▽⁀ )／                                                                                                                 |
| 14 декабря  |  15   | <ul><li>Методы повышения эффективности</li></ul>                                                    | [Методы повышения эффективности](Seminars/15-efficiency/efficiency.ipynb)              | —                                                                                                                           |
